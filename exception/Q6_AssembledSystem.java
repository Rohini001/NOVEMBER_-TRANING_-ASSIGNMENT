...
public class Q6_AssembledSystem {

	public static void main(String[] args) throws LowerRAMSizeException,MisMatchHardDiskException, HardDiskNotSupportedException {
				...
				&& as.getHDD()>=160 )
		{
			...
			throw new MisMatchHardDiskException("Entered HDD size is not matched with recommended HDD.");
		}
...
class MisMatchHardDiskException extends Exception {
	...
	public MisMatchHardDiskException(String s) {
		super(s);
	}
}
