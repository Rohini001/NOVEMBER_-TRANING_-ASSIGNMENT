...
public class Employee11 {
	...
	public Employee11(int empid, String empname, int empsalary, String empaddress, Date emp_dob, Date emp_doj) {
		super();
		this.empid = empid;
	...
	public String toString() {
		return "Employee11 [empid=" + empid + ", empname=" + empname + ", empsalary=" + empsalary + ", empaddress="
	...
	public static void main(String[] args) {
		...
		try {
			Employee11 emp = new Employee11(1, "rohini", 10000, "pune", null, null);
